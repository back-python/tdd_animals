...
def gerando_animais():
    for animal in lista_animais:
        ...
        predador = True if animal['predador'] == 'Sim' else False
        venenoso = True if animal['venenoso'] == 'Sim' else False
        domestico = True if animal['domestico'] == 'Sim' else False
        animal = Animal(animal_name=nome, predator=predador, venomous=venenoso, domestic=domestico)
        animal.save()
